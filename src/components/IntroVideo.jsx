    ...
    return (
      <div id="introvideo" className="bg-white">
        ...
        <div className="mx-auto max-w-4xl lg:text-center">
          ...
          Inspiring <span className="bg-gradient-to-r from-rose-400 via-fuchsia-500 to-indigo-500 bg-[length:100%_4px] bg-no-repeat bg-bottom"> Young Minds </span> to Code and Create !
          </p>
        </div>
