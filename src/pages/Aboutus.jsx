      ...
      <div className="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
          <div className="max-w-lgs">
            <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">SciTech Coder</h2>
            <p className="mt-4 text-gray-600 text-lg">At SciTech Coders, we offer engaging and hands-on science and coding programs designed to inspire creativity and ignite a passion for innovation in kids of all ages
            Join us on a journey where science and coding collide, unlocking a universe of endless possibilities and inspiring the innovators of tomorrow!</p>
            
          </div>
          <div className="mt-12 md:mt-0">
            <img src={AboutHero} alt="About Us Image" className="object-cover " />
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="bg-white ">
      <div className="container px-6 py-10 mx-auto">
        ...
        <div className="mt-8 lg:-mx-6 lg:flex lg:items-center">
          <img
            className="object-cover w-full lg:mx-6 lg:w-1/2 rounded-xl h-30 lg:h-30" src={Aboutus2} alt=""
          />
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            />
                    ...
                    <ul class="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-16 mb-10 border-b border-gray-200">
                        <li><a href="mailto:info@scitechcoders.co.uk" class="text-gray-800 hover:text-gray-900">email us at info@scitechcoders.co.uk</a></li>
                        <li><a href="#" class=" text-gray-800 hover:text-gray-900">033-3772-3137 / 07821-129-376</a></li>
                        <li><a href="#" class=" text-gray-800 hover:text-gray-900">98 Gibbins Road (Ground Floor), Stratford, London, E15 2HU</a></li>
